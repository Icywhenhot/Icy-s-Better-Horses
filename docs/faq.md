...
For this release, Minecraft **26.1.2**, NeoForge **26.1.2.71+**, and **Java 25 or newer**. Required mods: [GeckoLib](https://modrinth.com/mod/geckolib) 5.5.1+ and [Modonomicon](https://modrinth.com/mod/modonomicon) 2.2.0+.
...
No. It is optional and only adds the in-game settings screen. Without it, edit `config/icys-better-horses.json` directly. See [Configuration](configuration).
