...
// Server-side registry of all loaded, owned horses. Populated via entity load/unload events and bh_setOwner hooks. All access is on the server main thread — no synchronization needed.
