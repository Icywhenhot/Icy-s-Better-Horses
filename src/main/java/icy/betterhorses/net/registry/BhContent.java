...
public final class BhContent {
    ...
    public static final Holder.Reference<BreedType> THOROUGHBRED = register(BhRegistries.breedTypeRegistry(), "thoroughbred", () ->
            BreedType.builder(RACE.key())
                    ...
                    .entityType(entityKey(ModEntities.THOROUGHBRED_HORSE))
    ...
    public static final Holder.Reference<BreedType> ARABIAN = register(BhRegistries.breedTypeRegistry(), "arabian", () ->
            BreedType.builder(RACE.key())
                    ...
                    .entityType(entityKey(ModEntities.ARABIAN_HORSE))
                    .chestRows(3).bondedChestRows(3)
    ...
    public static final Holder.Reference<BreedType> QUARTER = register(BhRegistries.breedTypeRegistry(), "quarter", () ->
            BreedType.builder(RACE.key())
                    ...
                    .entityType(entityKey(ModEntities.QUARTER_HORSE))
                    .chestRows(3).bondedChestRows(3)
    ...
    public static final Holder.Reference<BreedType> FRIESIAN = register(BhRegistries.breedTypeRegistry(), "friesian", () ->
            BreedType.builder(WAR.key())
                    ...
                    .entityType(entityKey(ModEntities.FRIESIAN_HORSE))
                    .chestRows(3).bondedChestRows(3)
    ...
    public static final Holder.Reference<BreedType> ANDALUSIAN = register(BhRegistries.breedTypeRegistry(), "andalusian", () ->
            BreedType.builder(WAR.key())
                    ...
                    .entityType(entityKey(ModEntities.ANDALUSIAN_HORSE))
                    .chestRows(3).bondedChestRows(3)
    ...
    public static final Holder.Reference<BreedType> PERCHERON = register(BhRegistries.breedTypeRegistry(), "percheron", () ->
            BreedType.builder(DRAFT.key())
                    ...
                    .entityType(entityKey(ModEntities.PERCHERON_HORSE))
    ...
    public static final Holder.Reference<BreedType> CLYDESDALE = register(BhRegistries.breedTypeRegistry(), "clydesdale", () ->
            BreedType.builder(DRAFT.key())
                    ...
                    .entityType(entityKey(ModEntities.CLYDESDALE_HORSE))
                    .chestRows(4).bondedChestRows(4)
    ...
    public static final Holder.Reference<BreedType> SHIRE = register(BhRegistries.breedTypeRegistry(), "shire", () ->
            BreedType.builder(DRAFT.key())
                    ...
                    .entityType(entityKey(ModEntities.SHIRE_HORSE))
                    .chestRows(4).bondedChestRows(4)
    ...
    public static final Holder.Reference<BreedType> BELGIAN = register(BhRegistries.breedTypeRegistry(), "belgian", () ->
            BreedType.builder(DRAFT.key())
                    ...
                    .entityType(entityKey(ModEntities.BELGIAN_HORSE))
    ...
    public static final Holder.Reference<BreedType> ICELANDIC = register(BhRegistries.breedTypeRegistry(), "icelandic", () ->
            BreedType.builder(PONY.key())
                    ...
                    .entityType(entityKey(ModEntities.ICELANDIC_HORSE))
                    .chestRows(3).bondedChestRows(3)
    ...
    public static final Holder.Reference<BreedType> MUSTANG = register(BhRegistries.breedTypeRegistry(), "mustang", () ->
            BreedType.builder(WAR.key())
                    ...
                    .entityType(entityKey(ModEntities.MUSTANG_HORSE))
                    .chestRows(3).bondedChestRows(3)
    ...
    public static final Holder.Reference<BreedType> HAFLINGER = register(BhRegistries.breedTypeRegistry(), "haflinger", () ->
            BreedType.builder(PONY.key())
                    ...
                    .entityType(entityKey(ModEntities.HAFLINGER_HORSE))
    ...
    public static final Holder.Reference<BreedType> MORGAN = register(BhRegistries.breedTypeRegistry(), "morgan", () ->
            BreedType.builder(WESTERN.key())
                    ...
                    .entityType(entityKey(ModEntities.MORGAN_HORSE))
    ...
    public static final Holder.Reference<BreedType> AMERICAN_PAINT = register(BhRegistries.breedTypeRegistry(), "american_paint", () ->
            BreedType.builder(WESTERN.key())
                    ...
                    .entityType(entityKey(ModEntities.AMERICAN_PAINT_HORSE))
                    .chestRows(3).bondedChestRows(3)
                    .stabilizerBody(StabilizerBody.MEDIUM)
                    .build());
    ...
    public static final Holder.Reference<BreedType> APPALOOSA = register(BhRegistries.breedTypeRegistry(), "appaloosa", () ->
            BreedType.builder(WESTERN.key())
                    ...
                    .entityType(entityKey(ModEntities.APPALOOSA_HORSE))
                    .chestRows(3).bondedChestRows(3)
                    .ability(STOCK_HORSE.key())
                    .stabilizerBody(StabilizerBody.MEDIUM)
                    .build());

    public static final Holder.Reference<GenderType> MALE = register(BhRegistries.genderTypeRegistry(), "male", GenderType::new);
    public static final Holder.Reference<GenderType> FEMALE = register(BhRegistries.genderTypeRegistry(), "female", GenderType::new);

    public static final Holder.Reference<SpeciesType> SPECIES_NONE = register(BhRegistries.speciesTypeRegistry(), "none", SpeciesType::new);
    public static final Holder.Reference<SpeciesType> SPECIES_DONKEY = register(BhRegistries.speciesTypeRegistry(), "donkey", SpeciesType::new);
    public static final Holder.Reference<SpeciesType> SPECIES_MULE = register(BhRegistries.speciesTypeRegistry(), "mule", SpeciesType::new);
    public static final Holder.Reference<SpeciesType> SPECIES_SKELETON = register(BhRegistries.speciesTypeRegistry(), "skeleton", SpeciesType::new);
    public static final Holder.Reference<SpeciesType> SPECIES_ZOMBIE = register(BhRegistries.speciesTypeRegistry(), "zombie", SpeciesType::new);

    public static final Holder.Reference<CommandType> COMMAND_FOLLOW = register(BhRegistries.commandTypeRegistry(), "follow", CommandType::new);
    public static final Holder.Reference<CommandType> COMMAND_STAY = register(BhRegistries.commandTypeRegistry(), "stay", CommandType::new);
    public static final Holder.Reference<CommandType> COMMAND_RETURN_HOME = register(BhRegistries.commandTypeRegistry(), "return_home", CommandType::new);
    public static final Holder.Reference<CommandType> COMMAND_SET_HOME = register(BhRegistries.commandTypeRegistry(), "set_home", CommandType::new);
    public static final Holder.Reference<CommandType> COMMAND_WANDER = register(BhRegistries.commandTypeRegistry(), "wander", CommandType::new);
    public static final Holder.Reference<CommandType> COMMAND_ABILITY = register(BhRegistries.commandTypeRegistry(), "ability", CommandType::new);
    ...
    private static <T> Holder.Reference<T> register(Registry<T> registry, String path, Supplier<T> value) {
        return Registry.registerForHolder(registry, new ResourceLocation(IcysBetterHorses.MOD_ID, path), value.get());
    }

    private static ResourceKey<EntityType<?>> entityKey(EntityType<?> type) {
