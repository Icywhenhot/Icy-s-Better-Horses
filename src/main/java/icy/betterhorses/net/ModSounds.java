...
public final class ModSounds {
    ...
    public static void register(RegisterEvent event) {
        event.register(Registries.SOUND_EVENT, helper -> SOUNDS.forEach((path, sound) ->
                helper.register(ResourceLocation.fromNamespaceAndPath(IcysBetterHorses.RESOURCE_NAMESPACE, path), sound)));
    }

    private static SoundEvent register(String path) {
        ResourceLocation id = ResourceLocation.fromNamespaceAndPath(IcysBetterHorses.RESOURCE_NAMESPACE, path);
