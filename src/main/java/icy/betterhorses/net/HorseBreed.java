...
// Horse breed identifier. The first 15 entries are real breeds eligible for breeding; the rest are species placeholders for non-horse AbstractHorse subclasses on the info screen. Each real breed declares allowed coat combos (Variant × Markings) used both to roll a horse's coat and to infer its breed from an existing coat.
