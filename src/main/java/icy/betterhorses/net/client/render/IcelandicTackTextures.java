...
/**
 * Maps an equipped tack item to the Icelandic texture that should be drawn for it.
 *
...
public final class IcelandicTackTextures {
    ...
    /**
     * All six vanilla tiers now have their own Icelandic texture, so nothing falls back.
