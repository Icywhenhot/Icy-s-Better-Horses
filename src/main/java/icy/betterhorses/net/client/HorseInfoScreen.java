...
public class HorseInfoScreen extends Screen {
    ...
    // Display-unit conversions (match the stats HUD): speed_blocks_per_sec = raw * 43.2, jump_blocks = max(0, raw*6 - 1).
    private static final double SPEED_DISPLAY_FACTOR = 43.2D;

    // Mod-attainable max = vanilla base ceiling * full-bond multiplier (5 levels * 15% = +75%).
