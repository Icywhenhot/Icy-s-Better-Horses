...
public class HorseWanderBoundsGoal extends Goal {
    ...
    public boolean canUse() {
        ...
        if (!data.bh_isOwned() || !data.bh_getCommand().equals(BhContent.COMMAND_WANDER.getKey())) return false;
    ...
    public boolean canContinueToUse() {
        IHorseData data = IHorseData.of(horse);
        if (!data.bh_getCommand().equals(BhContent.COMMAND_WANDER.getKey())) return false;
        wanderCenter = data.bh_getWanderCenter();
